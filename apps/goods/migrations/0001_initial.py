    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(verbose_name='商品SPU', on_delete=models.CASCADE, to='goods.Goods')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.CharField(verbose_name='小图标', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
                ('sku', models.ForeignKey(verbose_name='商品', on_delete=models.CASCADE, to='goods.GoodsSKU')),
            ],
            options={
                'verbose_name': '首页轮播商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gtype', models.ForeignKey(verbose_name='商品类型', on_delete=models.CASCADE, to='goods.GoodsType')),
                ('sku', models.ForeignKey(verbose_name='商品', on_delete=models.CASCADE, to='goods.GoodsSKU')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goodssku',
            name='gtype',
            field=models.ForeignKey(verbose_name='商品种类', on_delete=models.CASCADE, to='goods.GoodsType'),
        ),
        migrations.AddField(
            model_name='goodsimage',
            name='sku',
            field=models.ForeignKey(verbose_name='商品', on_delete=models.CASCADE, to='goods.GoodsSKU'),
        ),
    ]
